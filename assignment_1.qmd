...
plot_data <- data.frame(
  Observed = subset(merged_data, nuts0 == "DE" & gini_n2 > 0)$gini_n2,
  Predicted = predict(lmquadDE, newdata = subset(merged_data, nuts0 == "DE" & gini_n2 > 0))
)

# Create a scatter plot
plot(plot_data$Predicted, plot_data$Observed, 
     xlab = "Predicted Values", ylab = "Observed Values",
     main = "Scatter Plot of Observed vs Predicted Values")

# Add a line representing the perfect fit (y = x)
abline(a = 0, b = 1, col = "red")

# Add a regression line
abline(lmquadDE, col = "blue")

# Add a legend
legend("topleft", legend = c("Perfect Fit", "Regression Line"),
