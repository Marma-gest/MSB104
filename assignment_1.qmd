...
# Use this and huxreg for data descriptions
#AT %>%
 # select(GDP,Population,GDP_pc_n3) %>% 

#data.frame(
 # Variable = names(summary_data),
 # Mean = summary_data[, "Mean"],
 # SD = summary_data[, "Std. Dev."],
...
The reason why then data dating back to 2012 may not have a connection with the fact that this is a war-torn country.
