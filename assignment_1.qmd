...
```{r}
lmgdpginiDE <- lm(gini_n2 ~ I(GDP/100000), subset(merged_data, year == 2010 & nuts0 == "DE"))
lmgdpginiIT <- lm(gini_n2 ~ I(GDP/100000), subset(merged_data, year == 2010 & nuts0 == "IT"))
huxreg(DE = lmgdpginiDE, IT = lmgdpginiIT) 
```
