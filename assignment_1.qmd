...
The reason why we uses GDP per capita on a regional level is because.
...
**Teori:** En økning i GDP per capita vil føre til en nedgang i Gini coefficient (regional inequity).
...
Det kommer et punkt hvor en økning i GDP per capita vil ha en større innvirkning på de som har lite GDP per capita, kontra de som har større GDP per capita.
