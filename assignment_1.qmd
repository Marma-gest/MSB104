...
```{r}
#| echo: false
lmlogDE <- lm(gini_n2 ~ logGDPpcn2, subset(merged_data, nuts0 == "DE" & gini_n2 > 0))

lmlogIT <- lm(gini_n2 ~ logGDPpcn2, subset(merged_data, nuts0 == "IT" & gini_n2 > 0))

lmlogSE <- lm(gini_n2 ~ logGDPpcn2, subset(merged_data, nuts0 == "SE" & gini_n2 > 0))
