...
```{r}
summary(is.na(merged2010))
```

```{r}
lmtest <- lm(gini_n2 ~ log(GDPpcn2) + log(education), subset(merged2010, year == 2010 & nuts0 == "DE" & gini_n2 > 0))

lmtest2 <- lm(gini_n2 ~ log(GDPpcn2) + log(education), subset(merged2010, year == 2010 & nuts0 == "IT" & gini_n2 > 0))

huxreg(DE = lmtest, IT = lmtest2, statistics = c("r.squared","adj.r.squared", "statistic", "p.value", "deviance"))
```

```{r}
lmtest <- lm(gini_n2 ~ log(GDPpcn2) + log(education) + roadratio , subset(merged2010, year == 2010 & nuts0 == "DE" & gini_n2 > 0))

lmtest2 <- lm(gini_n2 ~ log(GDPpcn2) + log(education) + roadratio, subset(merged2010, year == 2010 & nuts0 == "IT" & gini_n2 > 0))
