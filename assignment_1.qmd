...
```{r}
testmodelDE <- plm(gini_n2 ~ GDPpcn2 + log(GDPpcn2), data = pdataDE, model = "pooling")
testmodelIT <- plm(gini_n2 ~ GDPpcn2 + log(GDPpcn2), data = pdataIT, model = "pooling")
testmodelSE <- plm(gini_n2 ~ GDPpcn2 + log(GDPpcn2), data = pdataSE, model = "pooling")
huxreg(testmodelDE, testmodelIT, testmodelSE)
