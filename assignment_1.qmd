...
In other words, there is strong evidence of a positive linear relationship between the natural logarithm of GDP per capita and the Gini coefficient in Germany in 2010.
...
This implies that there is no strong statistical evidence of a linear relationship between the natural logarithm of GDP per capita and the Gini coefficient in Italy in 2010.
...
This is based on the assumption that a subregion with higher educated citizens will typically earn more than subregions with lesser educated citizens, thus increasing the difference in GDP per capita on the regional level.
