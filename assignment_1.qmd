...
-   Interpret and discuss the results, focusing on differences in development effects across subsets.
    Explain any observed variations.
...
-   Test for heteroskedasticity in the alternative and original models.
    Interpret and discuss the results and implications.
...
Should we divide our data into three subsets; one with all countries, one with tourists countries and one with all except tourist countries?

```{r}
merged_data$Germany <- ifelse(merged_data$nuts0 == "DE", 1,0)
merged_data$Other <- ifelse(merged_data$nuts0 == "DE", 0,1)

merged_data$Italy <- ifelse(merged_data$nuts0 == "IT", 1,0)
merged_data$Other <- ifelse(merged_data$nuts0 == "IT", 0,1)

merged_data$Italy <- ifelse(merged_data$nuts0 == "SE", 1,0)
merged_data$Other <- ifelse(merged_data$nuts0 == "SE", 0,1)
```
