...
As seen in the figure, as the X-axis increases, so does the coefficient of GDPpcn2.
This suggests that the increase in GDP per capita will have a growing impact on inequality.
While the coefficient is positive, a positive increase in GINI reflects a higher level of inequality.
This means that as the GDP per capita in Germany increases, the effect on the level of inequality grows increasingly.
...
The results of the test shows that the log models contain no heteroskedasticity ...

### 2. Causality discussion

-   Reflect on the causal interpretation of your models and suggest strategies to address any issues identified. (use coeff test with robust standard errors?)
