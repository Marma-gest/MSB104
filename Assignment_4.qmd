...
In the forthcoming visualization, we will explore the relationships between GDP and inequality using the quadratic and cubic estimates.
...
This decision is rooted in its better alignment with our theoretical framework, prioritizing consistency with our research hypotheses.
By employing the quadratic model, we aim to present a visual representation that not only captures the nuances of the data but also resonates with our conceptual understanding of the relationship between regional economic development and inequality in Germany and Italy.
