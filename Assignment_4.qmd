...
Below is a table of a linear regression of inequality (GINIW) with logGDP as the independant variable, showing the baseline for our findings.
...
In the forthcoming visualization, the relationships between log(GDP) and inequality using the quadratic and cubic estimates.
Although the cubic model exhibits marginally higher explanatory power than the quadratic one, we have opted to visualize the quadratic model.
